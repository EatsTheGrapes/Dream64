...
pub(crate) use self::fastpath_jit::{
    ...
    try_run_guarded_jit, try_run_parsed_dmm_new_fast_path, try_run_region_numeric_jit,
    try_run_register_signal_fast_path, try_run_rooted_list_jit,
};
...
pub(crate) use self::{
    fastpath_jit::{
        REGISTER_SIGNAL_FAST_CACHE, compile_corner_apply_body, compile_lumcount_trace,
        compile_register_signal_trace, compile_rooted_list_trace, discover_offset_native,
        jit_disabled, numeric_trace_instructions,
    },
    numeric_core::{
